      ...
      <div className="main-container2">
        ...
        <div className="product-container3">
          {archivedNotes.length !== 0 && (
            <h1 style={{ marginLeft: "30rem" }}>Archived Items</h1>
          )}
          <section className="cards" id="cards">
            {archivedNotes.length === 0 ? (
              <h1 style={{ marginTop: "15rem", marginLeft: "4rem" }}>
                No Archived
              </h1>
            ) : (
                    ...
                    >
                      <div className="card-text-container">
                        ...
                        <span className="card_tags_container">
                          ...
                          <button className="btn card_tags">
                            {note.priority}
                          </button>
                        </span>
                        <span className="card_icons_container">
                          <i
                            className="card_icons fa-solid fa-clock-rotate-left"
                            onClick={() => {
                          ...
                          <i
                            ...
                            onClick={() => {
                              deleteFromArchive(note._id, note);
                            }}
                          ></i>
                        </span>
                      </div>
